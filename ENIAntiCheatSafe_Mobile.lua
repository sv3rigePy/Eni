...
-- ═════════════════════════════════════════════════
--   MOVEMENT: Anti-Cheat-Safe mit natural jitter + speed cap
-- ═════════════════════════════════════════════════
do
local SAFE_SPEED_CAP = 12  -- max extra (16+12 = 28 total, unter meisten thresholds)
...
print("[ENI HUB - ANTI CHEAT TEST MOBILE] loaded")
